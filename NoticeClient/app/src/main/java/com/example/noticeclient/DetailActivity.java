...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "이 액티비티가 초기화 될 때 넘겨받은 notice_idx"+notice_idx);
        ...
        handler=new Handler(Looper.getMainLooper()){
            ...
            public void handleMessage(@NonNull Message msg) {
                //메인스레드에 의해 수행된다. 따라서 디자인 제어가 가능하다.
    ...
    public void del() {
        // getDetail이랑 유사해서 복붙함
        BufferedReader buffr=null;
        InputStreamReader reader=null;
        try {
            URL url=new URL("http://172.30.1.56:7777/rest/notice/del?notice_idx="+notice_idx);
...
//                convertJsonToObject(json);
    ...
    public void convertJsonToObject(JSONObject json){
        ...
        try {
            ...
            // 화면에 반영하기 (네트워크 통신은 개발자가 정의한 쓰레드에 의해 진행되었으므로
    ...
    public void getDetail(){
        ...
        try {
            URL url=new URL("http://172.30.1.56:7777/rest/notice/detail?notice_idx="+notice_idx);
            URLConnection uCon=url.openConnection();
            HttpURLConnection httpCon=(HttpURLConnection)uCon;
            httpCon.setRequestMethod("GET");
            httpCon.setDoInput(true);
    ...
    public void edit(){
        ...
        try {
            //Http Request
            URL url=new URL("http://172.30.1.56:7777/rest/notice/edit");
            URLConnection uCon= url.openConnection();
            HttpURLConnection httpCon=(HttpURLConnection) uCon;
            ...
            Log.d(TAG, "수정 성공 여부는 ?! "+sb.toString());
            //수정 성공시, Alert 성공메시지 출력ㅁ
